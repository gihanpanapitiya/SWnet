...
handler = logging.FileHandler( os.path.join(CANDLE_DATA_DIR, "SWnet/Output/log.txt"), mode='w' )
...
def run(gParameters):
    ...
    # base_path = gParameters['base_path']
    base_path=os.path.join(CANDLE_DATA_DIR, 'SWnet','Data')
    ...
    untils.get_data(data_url, CANDLE_DATA_DIR, download_data)
